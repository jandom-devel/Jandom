/**
  * Copyright 2013, 2018 Gianluca Amato <gianlcua.amato@unich.it>
  *
...
/**
  ...
  */
trait CartesianFiberedProperty[Type, Property <: CartesianFiberedProperty[Type, Property]] extends AbstractProperty[Property] {
  this: Property =>
